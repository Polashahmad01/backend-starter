...
import { IEmailService } from "../types/auth";
    ...
    return `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
          <h1 style="color: #2c3e50; text-align: center; margin-bottom: 30px;">Welcome to ${config.app.name}!</h1>
          
          <p>Hi ${firstName},</p>
          
          <p>Thank you for signing up! To complete your registration and start using ${config.app.name}, please verify your email address by clicking the button below:</p>
